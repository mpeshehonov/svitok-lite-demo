      ...
      {documents.map((document) => {
        ...
        return (
          <Button
            ...
            disabled={disabled}
            className={cn(
              "h-auto min-h-14 cursor-pointer justify-start rounded-xl border-svitok-border bg-svitok-card px-4 py-3 text-left whitespace-normal transition-all duration-200 hover:-translate-y-0.5 hover:bg-svitok-card hover:shadow-[0_8px_24px_rgba(0,0,0,0.25)]",
              isActive &&
